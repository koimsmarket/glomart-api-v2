-- GM_DB_V004_RESET
-- 주의: 기존 gm_ 데이터 전체 삭제 후 재생성

DROP TABLE IF EXISTS gm_cs CASCADE;
DROP TABLE IF EXISTS gm_order_items CASCADE;
DROP TABLE IF EXISTS gm_orders CASCADE;
DROP TABLE IF EXISTS gm_basket CASCADE;
DROP TABLE IF EXISTS gm_products CASCADE;
DROP TABLE IF EXISTS gm_suppliers CASCADE;
