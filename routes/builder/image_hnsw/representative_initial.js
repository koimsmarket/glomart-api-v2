'use strict';
// GM_BUILDER_IMAGE_HNSW_REPRESENTATIVE_INITIAL_V030_NO_MIGRATION_QUEUE
...
function initialLog(stage,data){
  try{console.log(`[GM_BUILDER_IMAGE_HNSW_REPRESENTATIVE_INITIAL_V029_ALI_OPTION_IDENTITY] ${stage} ${JSON.stringify(data||{})}`);}catch(_){console.log(`[GM_BUILDER_IMAGE_HNSW_REPRESENTATIVE_INITIAL_V029_ALI_OPTION_IDENTITY] ${stage}`);}
}
